...
CREME_FARBE = ["#f4f0e4", "#ece5d2", "#6e685b", "#14130f"]

BINAER_VERLAUF_OPPOSITE = {
    2: ['#1b3f68', '#b24d24'],
    ...
    10: [ "#0d1c2e", '#1b3f68', '#1b3f68', '#255182', '#4471a2', '#a0b9d3', '#d8dbe1', '#ecd9cc', '#d69d81', '#b24d24'],
}
BINAER_VERLAUF = {
    2: ['#b24d24', '#1b3f68'],
    ...
    10: ['#b24d24', '#d69d81', '#ecd9cc', '#d8dbe1', '#a0b9d3', '#4471a2', '#255182', '#1b3f68', '#1b3f68', "#0d1c2e"],
}

FARBEN_4 = {"grün": "#4c7a3a", "rot": "#b24d24","blau": "#3c699a","gelb": "#c48a2a"}
FARBEN_4_ABSTUFUNGEN = {
    "grün": {
        "sehr_hell":  "#c9d7c4",
        "hell":       "#93af89",
        "basis":      "#4c7a3a",
